    ...
    <div className='login-page'>
      <div className='login-block'>
        ...
        <form>
          ...
          <button type='button' className='github-button' onClick={window.location.href = `https://github.com/login/oauth/authorize?client_id=0f540b0a747d0921412c&redirect_uri=http://localhost:5000/api/profile&scope=read:user`}>
            Login with GitHub
          </button>
        </form>
      </div>
